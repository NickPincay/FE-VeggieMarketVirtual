...
import { TableProvidersComponent } from './components/providers/table-providers/table-providers.component';
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'table-providers', component: TableProvidersComponent },
